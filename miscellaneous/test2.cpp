...
// Draw the player
void drawPlayer() {
    double (*shape)[2]; // pointer to arrays of double[2]
    int vertexCount = 0;
    ...
    double rotatedX[20], rotatedY[20]; // 20 is enough for all our shapes
    ...
    // Set color based on player level or other logic
    if (playerLevel <= 3) {
